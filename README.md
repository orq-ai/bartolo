...
- `auth profile remove <name>` (aliases `rm`, `delete`) deletes a stored profile without hand-editing `credentials.json`; removing the active one clears the selection.
